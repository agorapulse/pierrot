...
[source,bash]
----
include::{root-dir}/apps/pierrot/src/tset/resources/com/agorapulse/pierrot/cli/PierrotCommandSpec/help.txt[]
----
...
[source,bash]
----
include::{root-dir}/apps/pierrot/src/tset/resources/com/agorapulse/pierrot/cli/SearchCommandSpec/help.txt[]
----
...
pierrot init \
  ...
  --message="Upgraded Micronaut to the latset version 3.1.x" \
...
[source,bash]
----
include::{root-dir}/apps/pierrot/src/tset/resources/com/agorapulse/pierrot/cli/InitCommandSpec/help.txt[]
----
...
[source,bash]
----
include::{root-dir}/apps/pierrot/src/tset/resources/com/agorapulse/pierrot/cli/CreateCommandSpec/help.txt[]
----
...
[source,bash]
----
include::{root-dir}/apps/pierrot/src/tset/resources/com/agorapulse/pierrot/cli/DeleteCommandSpec/help.txt[]
----
...
[source,bash]
----
include::{root-dir}/apps/pierrot/src/tset/resources/com/agorapulse/pierrot/cli/PullCommandSpec/help.txt[]
----
...
[source,bash]
----
include::{root-dir}/apps/pierrot/src/tset/resources/com/agorapulse/pierrot/cli/PushCommandSpec/help.txt[]
----
...
pierrot replace \
  ...
  --message="Upgraded Micronaut to the latset version 3.1.0" \
...
[source,bash]
----
include::{root-dir}/apps/pierrot/src/tset/resources/com/agorapulse/pierrot/cli/ReplaceCommandSpec/help.txt[]
----
...
[source,bash]
----
include::{root-dir}/apps/pierrot/src/tset/resources/com/agorapulse/pierrot/cli/StatusCommandSpec/help.txt[]
----

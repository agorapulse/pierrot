...
[source,bash]
----
include::{root-dir}/apps/pierrot/src/test/resources/com/agorapulse/pierrot/PierrotCommandSpec/help.txt[]
----
...
[source,bash]
----
include::{root-dir}/apps/pierrot/src/test/resources/com/agorapulse/pierrot/SearchCommandSpec/help.txt[]
----
...
[source,bash]
----
include::{root-dir}/apps/pierrot/src/test/resources/com/agorapulse/pierrot/CreateCommandSpec/help.txt[]
----
...
[source,bash]
----
include::{root-dir}/apps/pierrot/src/test/resources/com/agorapulse/pierrot/DeleteCommandSpec/help.txt[]
----
...
[source,bash]
----
include::{root-dir}/apps/pierrot/src/test/resources/com/agorapulse/pierrot/PullCommandSpec/help.txt[]
----
...
[source,bash]
----
include::{root-dir}/apps/pierrot/src/test/resources/com/agorapulse/pierrot/PushCommandSpec/help.txt[]
----
...
[source,bash]
----
include::{root-dir}/apps/pierrot/src/test/resources/com/agorapulse/pierrot/ReplaceCommandSpec/help.txt[]
----

[[_status]]
=== Status Command

The `status` command allows search pull requests and display their status.
...
[source,bash]
----
include::{root-dir}/apps/pierrot/src/test/resources/com/agorapulse/pierrot/StatusCommandSpec/help.txt[]
----
